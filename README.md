...
在智能电视使用场景中，经常需要将手机或电脑上的文件（视频、图片、文档等）传送到电视上查看。传统方式往往需要
U 盘拷贝或复杂的网络配置。阳光快传提供了一个零配置、开箱即用的解决方案——只需在同一局域网内，通过浏览器即可轻松上传文件到电视。
...
点击标题栏右侧的"检查更新"按钮，应用会从 GitHub 检查是否有新版本，发现更新后可下载安装。
